...
const IconPais = ({ size, pais }) => {
    ...
    return (
        <svg className={`${iconSizeClass}`} xmlns="http://www.w3.org/2000/svg" width={iconDimensions.width} height={iconDimensions.height} viewBox={iconDimensions.viewBox} fill="none">
